        ...
        <div className="projects-card">
          ...
          <div className="card__descr-wrapper">
            ...
            <p className="card__descr">
              ...
              HTML, CSS, and JavaScript, focusing on a clean user interface and
              foundational front-end development skills.
            </p>
        ...
        <div className="projects-card">
          ...
          <div className="card__descr-wrapper">
            ...
            <p className="card__descr">
              ...
              the Playlabs Game Jam, highlighting strong teamwork and rapid game
