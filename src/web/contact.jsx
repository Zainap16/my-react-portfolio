      ...
      <section id="contact">
        ...
        <div id="availability" className="exp-item">
          ...
          <p className="contact-desc divider">
            I&apos;m currently seeking junior or internship opportunities in web
            development, Python programming, and any other software
            development-related fields. I&apos;m eager to gain hands-on industry
            experience where I can apply and grow my skills in building
            applications, solving problems, and working within real development
            teams. I&apos;m especially interested in roles that allow me to
            learn modern development practices, contribute to meaningful
            projects, and continue improving my abilities across both frontend
